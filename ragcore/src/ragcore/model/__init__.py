...
2. **Type.** :class:`~ragcore.model.egress.ModelEgressPort` is what the adapter holds,
...
The local development seam (:mod:`ragcore.model.local`) exists so that the first of
