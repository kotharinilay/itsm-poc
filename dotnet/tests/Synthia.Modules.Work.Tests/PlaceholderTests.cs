namespace Synthia.Modules.Work.Tests;
...
/// Replaced by behaviour tests as Synthia.Modules.Work gains behaviour.
/// </summary>
public sealed class PlaceholderTests
{
    ...
    {
        Assert.NotNull(typeof(Synthia.Modules.Work.AssemblyMarker).Assembly);
    }
}
