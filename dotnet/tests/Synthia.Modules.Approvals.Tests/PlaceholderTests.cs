namespace Synthia.Modules.Approvals.Tests;
...
/// Replaced by behaviour tests as Synthia.Modules.Approvals gains behaviour.
/// </summary>
public sealed class PlaceholderTests
{
    ...
    {
        Assert.NotNull(typeof(Synthia.Modules.Approvals.AssemblyMarker).Assembly);
    }
}
