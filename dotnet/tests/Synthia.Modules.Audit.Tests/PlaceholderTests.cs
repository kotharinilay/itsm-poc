namespace Synthia.Modules.Audit.Tests;
...
/// Replaced by behaviour tests as Synthia.Modules.Audit gains behaviour.
/// </summary>
public sealed class PlaceholderTests
{
    ...
    {
        Assert.NotNull(typeof(Synthia.Modules.Audit.AssemblyMarker).Assembly);
    }
}
