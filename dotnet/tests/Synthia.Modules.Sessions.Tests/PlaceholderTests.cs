namespace Synthia.Modules.Sessions.Tests;
...
/// Replaced by behaviour tests as Synthia.Modules.Sessions gains behaviour.
/// </summary>
public sealed class PlaceholderTests
{
    ...
    {
        Assert.NotNull(typeof(Synthia.Modules.Sessions.AssemblyMarker).Assembly);
    }
}
