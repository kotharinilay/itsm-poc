namespace Synthia.Modules.Tenancy.Tests;
...
/// Replaced by behaviour tests as Synthia.Modules.Tenancy gains behaviour.
/// </summary>
public sealed class PlaceholderTests
{
    ...
    {
        Assert.NotNull(typeof(Synthia.Modules.Tenancy.AssemblyMarker).Assembly);
    }
}
